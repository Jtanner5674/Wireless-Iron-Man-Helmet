...
#define APP_KEY           "app key here"      // Should look like "de0bxxxx-1x3x-4x3x-ax2x-5dabxxxxxxxx"
#define APP_SECRET        "secret here"   // Should look like "5f36xxxx-x3x7-4x3x-xexe-e86724a9xxxx-4c4axxxx-3x3x-x5xe-x9x3-333d65xxxxxx"
...
//Do not touch past here unless you know what your doing

static int distance = 180;
static int pos = distance;
static int pos2 = 0;
...
bool onPowerState(const String &deviceId, bool &state) {
  ...
  Serial.print("Updating Pos from:");
  Serial.print(pos);
  Serial.print("and pos2 from:");
  Serial.print(pos2);
  pos = (distance - pos) + 30;
  pos2 = (distance - pos2) + 30;
  Serial.print("to:");
  Serial.print(pos);
  Serial.print("and");
  Serial.print(pos2);
  Serial.printf("position SHOULD be: ");
  Serial.print(pos);
  while (start <= stop) {
    myservo.write(pos);
    myservo2.write(pos2);
